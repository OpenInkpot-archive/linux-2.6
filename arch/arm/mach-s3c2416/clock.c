...
static int s3c2416_clkcon_enable_h(struct clk *clk, int enable)
{
	...
	clkcon = __raw_readl(S3C2416_HCLKCON);
	...
	__raw_writel(clkcon, S3C2416_HCLKCON);
...
static int s3c2416_clkcon_enable_p(struct clk *clk, int enable)
{
	...
	clkcon = __raw_readl(S3C2416_PCLKCON);
	...
	__raw_writel(clkcon, S3C2416_PCLKCON);
...
static int s3c2416_clkcon_enable_s(struct clk *clk, int enable)
{
	...
	clkcon = __raw_readl(S3C2416_SCLKCON);
	...
	__raw_writel(clkcon, S3C2416_SCLKCON);
...
static int s3c2416_setparent_epllref(struct clk *clk, struct clk *parent)
{
	...
	clksrc &= ~S3C2416_CLKSRC_EPLLREF_MASK;

	if (parent == &clk_xtal)
		clksrc |= S3C2416_CLKSRC_EPLLREF_XTAL;
	else if (parent == &clk_ext)
		clksrc |= S3C2416_CLKSRC_EPLLREF_EXTCLK;
...
{
	unsigned long parent_rate = clk_get_rate(clk->parent);
	unsigned long div = __raw_readl(S3C2416_CLKDIV0);

	div  &= S3C2416_CLKDIV0_EXTDIV_MASK;
	div >>= (S3C2416_CLKDIV0_EXTDIV_SHIFT-1);	/* x2 */
...
static int s3c2416_setparent_msysclk(struct clk *clk, struct clk *parent)
{
	...
	clksrc &= ~(S3C2416_CLKSRC_MSYSCLK_MPLL |
		    S3C2416_CLKSRC_EXTCLK_DIV);

	if (parent == &clk_mpll)
		clksrc |= S3C2416_CLKSRC_MSYSCLK_MPLL;
	else if (parent == &clk_mdivclk)
		clksrc |= S3C2416_CLKSRC_EXTCLK_DIV;
	else if (parent != &clk_mpllref)
		return -EINVAL;
...
static int s3c2416_setparent_armclk(struct clk *clk, struct clk *parent)
{
	unsigned long clkdiv0;

	clkdiv0 = __raw_readl(S3C2416_CLKDIV0);

	if (parent == &clk_armdiv)
		clkdiv0 &= ~S3C2416_CLKDIV0_DVS;
	else if (parent == &clk_h)
		clkdiv0 |= S3C2416_CLKDIV0_DVS;
	else
		return -EINVAL;

	__raw_writel(clkdiv0, S3C2416_CLKDIV0);
	return 0;
}
...
static struct clk clk_arm = {
	.name		= "armclk",
	.id		= -1,
	.set_parent	= s3c2416_setparent_armclk,
};
...
static int s3c2416_setparent_esysclk(struct clk *clk, struct clk *parent)
{
	...
	if (parent == &clk_epll)
		clksrc |= S3C2416_CLKSRC_ESYSCLK_EPLL;
...
static unsigned long s3c2416_getrate_uart(struct clk *clk)
{
	...
	div &= S3C2416_CLKDIV1_UARTDIV_MASK;
	div >>= S3C2416_CLKDIV1_UARTDIV_SHIFT;
...
static int s3c2416_setrate_uart(struct clk *clk, unsigned long rate)
{
	...
	clkdivn &= ~S3C2416_CLKDIV1_UARTDIV_MASK;
	clkdivn |= (rate - 1) << S3C2416_CLKDIV1_UARTDIV_SHIFT;
...
static unsigned long s3c2416_getrate_hsspi(struct clk *clk)
{
	...
	div &= S3C2416_CLKDIV1_HSSPIDIV_MASK;
	div >>= S3C2416_CLKDIV1_HSSPIDIV_SHIFT;
...
static int s3c2416_setrate_hsspi(struct clk *clk, unsigned long rate)
{
	...
	clkdivn &= ~S3C2416_CLKDIV1_HSSPIDIV_MASK;
	clkdivn |= (rate - 1) << S3C2416_CLKDIV1_HSSPIDIV_SHIFT;
...
static unsigned long s3c2416_getrate_usbhost(struct clk *clk)
{
	...
	div &= S3C2416_CLKDIV1_USBHOSTDIV_MASK;
	div >>= S3C2416_CLKDIV1_USBHOSTDIV_SHIFT;
...
static int s3c2416_setrate_usbhost(struct clk *clk, unsigned long rate)
{
	...
	clkdivn &= ~S3C2416_CLKDIV1_USBHOSTDIV_MASK;
	clkdivn |= (rate - 1) << S3C2416_CLKDIV1_USBHOSTDIV_SHIFT;
...
static struct clk clk_usb_bus_host = {
	...
	.id		= -1,
	.parent		= &clk_esysclk,
	.ctrlbit	= S3C2416_SCLKCON_USBHOST,
	.enable		= s3c2416_clkcon_enable_s,
...
static unsigned long s3c2416_getrate_i2s_eplldiv(struct clk *clk)
{
	...
	div &= S3C2416_CLKDIV1_I2SDIV_MASK;
	div >>= S3C2416_CLKDIV1_I2SDIV_SHIFT;
...
static int s3c2416_setrate_i2s_eplldiv(struct clk *clk, unsigned long rate)
{
	...
	clkdivn &= ~S3C2416_CLKDIV1_I2SDIV_MASK;
	clkdivn |= (rate - 1) << S3C2416_CLKDIV1_I2SDIV_SHIFT;
...
static int s3c2416_setparent_i2s(struct clk *clk, struct clk *parent)
{
	...
	clksrc &= ~S3C2416_CLKSRC_I2S_MASK;

	if (parent == &clk_epllref)
		clksrc |= S3C2416_CLKSRC_I2S_EPLLREF;
	else if (parent == &clk_i2s_ext)
		clksrc |= S3C2416_CLKSRC_I2S_EXT;
...
static struct clk clk_i2s = {
	...
	.ctrlbit	= S3C2416_SCLKCON_I2SCLK,
	.enable		= s3c2416_clkcon_enable_s,
...
static unsigned long s3c2416_getrate_display(struct clk *clk)
{
	...
	div &= S3C2416_CLKDIV1_DISPDIV_MASK;
	div >>= S3C2416_CLKDIV1_DISPDIV_SHIFT;
...
static struct clk clk_display = {
	...
	.id		= -1,
	.parent		= &clk_esysclk,
	.ctrlbit	= S3C2416_SCLKCON_DISPCLK,
	.enable		= s3c2416_clkcon_enable_s,
...
static unsigned long s3c2416_prediv_getrate(struct clk *clk)
{
	unsigned long rate = clk_get_rate(clk->parent);
	unsigned long clkdiv0 = __raw_readl(S3C2416_CLKDIV0);

	clkdiv0 &= S3C2416_CLKDIV0_PREDIV_MASK;
	clkdiv0 >>= S3C2416_CLKDIV0_PREDIV_SHIFT;
...
static struct clk clk_prediv = {
	...
	.id		= -1,
	.parent		= &clk_msysclk,
	.get_rate	= s3c2416_prediv_getrate,
};
...
static struct clk init_clocks_disable[] = {
	{
		...
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_ADC,
	}, {
		.name		= "i2c",
		.id		= -1,
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_IIC,
	}, {
		.name		= "iis",
		.id		= -1,
		.parent		= &clk_p,
...
static struct clk init_clocks[] = {
	{
		...
		.ctrlbit	= S3C2416_HCLKCON_DMA0,
	}, {
		.name		= "dma",
		.id		= 1,
		.parent		= &clk_h,
		.enable		= s3c2416_clkcon_enable_h,
		.ctrlbit	= S3C2416_HCLKCON_DMA1,
	}, {
		.name		= "dma",
		.id		= 2,
		.parent		= &clk_h,
		.enable		= s3c2416_clkcon_enable_h,
		.ctrlbit	= S3C2416_HCLKCON_DMA2,
	}, {
		.name		= "dma",
		.id		= 3,
		.parent		= &clk_h,
		.enable		= s3c2416_clkcon_enable_h,
		.ctrlbit	= S3C2416_HCLKCON_DMA3,
	}, {
		.name		= "dma",
		.id		= 4,
		.parent		= &clk_h,
		.enable		= s3c2416_clkcon_enable_h,
		.ctrlbit	= S3C2416_HCLKCON_DMA4,
	}, {
		.name		= "dma",
		.id		= 5,
		.parent		= &clk_h,
		.enable		= s3c2416_clkcon_enable_h,
		.ctrlbit	= S3C2416_HCLKCON_DMA5,
	}, {
		.name		= "lcd",
		.id		= -1,
		.parent		= &clk_h,
		...
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_GPIO,
	}, {
		.name		= "usb-host",
		.id		= -1,
		.parent		= &clk_h,
		.enable		= s3c2416_clkcon_enable_h,
		.ctrlbit	= S3C2416_HCLKCON_USBH,
	}, {
		.name		= "usb-device",
		.id		= -1,
		.parent		= &clk_h,
		...
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_PWMT,
	}, {
		.name		= "uart",
		.id		= 0,
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_UART0,
	}, {
		.name		= "uart",
		.id		= 1,
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_UART1,
	}, {
		.name		= "uart",
		.id		= 2,
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_UART2,
	}, {
		.name		= "uart",
		.id		= 3,
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_UART3,
	}, {
		.name		= "rtc",
		.id		= -1,
		.parent		= &clk_p,
		.enable		= s3c2416_clkcon_enable_p,
		.ctrlbit	= S3C2416_PCLKCON_RTC,
	}, {
		.name		= "watchdog",
		.id		= -1,
		.parent		= &clk_p,
...
static void __init s3c2416_clk_initparents(void)
{
	...
	switch (clksrc & S3C2416_CLKSRC_EPLLREF_MASK) {
	case S3C2416_CLKSRC_EPLLREF_EXTCLK:
		parent = &clk_ext;
		break;

	case S3C2416_CLKSRC_EPLLREF_XTAL:
	default:
		parent = &clk_xtal;
		break;

	case S3C2416_CLKSRC_EPLLREF_MPLLREF:
	case S3C2416_CLKSRC_EPLLREF_MPLLREF2:
		parent = &clk_mpllref;
		break;
	}
	...
	switch (clksrc & S3C2416_CLKSRC_I2S_MASK) {
	case S3C2416_CLKSRC_I2S_EXT:
		parent = &clk_i2s_ext;
		break;

	case S3C2416_CLKSRC_I2S_EPLLDIV:
	default:
		parent = &clk_i2s_eplldiv;
		break;

	case S3C2416_CLKSRC_I2S_EPLLREF:
	case S3C2416_CLKSRC_I2S_EPLLREF3:
		parent = &clk_epllref;
	}
	...
	parent = (clksrc & S3C2416_CLKSRC_ESYSCLK_EPLL) ?
	...
	if (clksrc & S3C2416_CLKSRC_MSYSCLK_MPLL) {
		parent = &clk_mpll;
	} else {
		parent = (clksrc & S3C2416_CLKSRC_EXTCLK_DIV) ?
...
static unsigned int armdiv[16] = {
	[S3C2416_CLKDIV0_ARMDIV_1 >> S3C2416_CLKDIV0_ARMDIV_SHIFT]	= 1,
	[S3C2416_CLKDIV0_ARMDIV_2 >> S3C2416_CLKDIV0_ARMDIV_SHIFT]	= 2,
	[S3C2416_CLKDIV0_ARMDIV_3 >> S3C2416_CLKDIV0_ARMDIV_SHIFT]	= 3,
	[S3C2416_CLKDIV0_ARMDIV_4 >> S3C2416_CLKDIV0_ARMDIV_SHIFT]	= 4,
	[S3C2416_CLKDIV0_ARMDIV_6 >> S3C2416_CLKDIV0_ARMDIV_SHIFT]	= 6,
	[S3C2416_CLKDIV0_ARMDIV_8 >> S3C2416_CLKDIV0_ARMDIV_SHIFT]	= 8,
};

static inline unsigned int s3c2416_fclk_div(unsigned long clkdiv0)
{
	clkdiv0 &= S3C2416_CLKDIV0_ARMDIV_MASK;

	return armdiv[clkdiv0 >> S3C2416_CLKDIV0_ARMDIV_SHIFT];
}

static inline unsigned long s3c2416_get_hdiv(unsigned long clkcon0)
{
	clkcon0 &= S3C2416_CLKDIV0_HCLKDIV_MASK;
...
{
	unsigned long epllcon = __raw_readl(S3C2416_EPLLCON);
	unsigned long mpllcon = __raw_readl(S3C2416_MPLLCON);
	unsigned long clkdiv0 = __raw_readl(S3C2416_CLKDIV0);
	unsigned long pll;
	unsigned long fclk;
	unsigned long hclk;
	...
	printascii("s3c2416_init_clocks\n");

	/* s3c2416 parents h and p clocks from prediv */
	clk_h.parent = &clk_prediv;
	clk_p.parent = &clk_prediv;

	pll = s3c2416_get_mpll(mpllcon, xtal);
	clk_msysclk.rate = pll;

	fclk = pll / s3c2416_fclk_div(clkdiv0);
	hclk = s3c2416_prediv_getrate(&clk_prediv);
	hclk /= s3c2416_get_hdiv(clkdiv0);
	pclk = hclk / ((clkdiv0 & S3C2416_CLKDIV0_HALF_PCLK) ? 2 : 1);

	s3c24xx_setup_clocks(xtal, fclk, hclk, pclk);

	snprintf(buf, 256, "S3C2416: mpll %s %ld.%03ld MHz, cpu %ld.%03ld MHz, mem %ld.%03ld MHz, pclk %ld.%03ld MHz\n",
	       (mpllcon & S3C2416_PLLCON_OFF) ? "off":"on",
	...
	clk_epll.rate = s3c2416_get_epll(epllcon, xtal);
	...
	snprintf(buf, 256, "S3C2416: epll %s %ld.%03ld MHz, usb-bus %ld.%03ld MHz\n",
	       (epllcon & S3C2416_PLLCON_OFF) ? "off":"on",
