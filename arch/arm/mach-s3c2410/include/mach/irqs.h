...
#define IRQ_S3C2416_DMA		S3C2412_IRQ(17)
#define IRQ_S3C2416_UART3	S3C2412_IRQ(18)
#define IRQ_S3C2416_SDI1	S3C2412_IRQ(20)
#define IRQ_S3C2416_SDI0	S3C2412_IRQ(21)
